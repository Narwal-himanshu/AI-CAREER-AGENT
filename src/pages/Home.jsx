...
const GLOW_COLORS = [
  { glow: 'rgba(62,123,250,0.32)', border: 'rgba(62,123,250,0.35)' },   // signal / cobalt
  { glow: 'rgba(124,111,239,0.30)', border: 'rgba(124,111,239,0.35)' }, // ember / violet
  { glow: 'rgba(124,111,239,0.30)', border: 'rgba(124,111,239,0.35)' }, // ember / violet
  { glow: 'rgba(62,123,250,0.28)', border: 'rgba(62,123,250,0.32)' },   // signal / cobalt
]
  ...
  return (
    <section className="bg-paper py-16 md:py-24 border-b border-mist overflow-hidden relative">
      ...
      <div className="hidden md:flex absolute inset-0 pointer-events-none overflow-hidden max-w-[1400px] mx-auto">
        ...
        <div className="absolute top-1/2 -left-4 w-20 h-20 rounded-full bg-signal/10 backdrop-blur-2xl flex items-center justify-center shape-float-slow">
          <Milestone className="w-10 h-10 text-signal opacity-50" />
        </div>
        ...
        <Reveal delay={150} className="flex flex-col items-center justify-center relative">
          ...
          <div className="bg-white border border-mist p-8 rounded-3xl shadow-lg flex flex-col items-center gap-4 relative">
            ...
            <div className="relative flex items-center justify-center">
              ...
              <div className="absolute inset-0 bg-gradient-to-tr from-signal via-ember to-signal blur-2xl opacity-20 rounded-full scale-90"></div>

              <svg className="w-56 h-56 relative z-10" viewBox="0 0 100 100">
                <defs>
                  <linearGradient id="score-gradient" x1="0%" y1="0%" x2="100%" y2="100%">
                    <stop offset="0%" stopColor="#3E7BFA" /> {/* signal */}
                    <stop offset="50%" stopColor="#7C6FEF" /> {/* ember / violet */}
                    <stop offset="100%" stopColor="#3E7BFA" /> {/* signal */}
                  </linearGradient>
                </defs>
                <circle 
                  cx="50" 
...
const PARTNER_LOGOS = [
  { name: 'LeetCode', icon: Code2, color: '#4E6178' },
  { name: 'GeeksforGeeks', icon: Terminal, color: '#4E6178' },
  { name: 'Udemy', icon: GraduationCap, color: '#4E6178' },
  { name: 'Coursera', icon: BookOpen, color: '#4E6178' },
  { name: 'YouTube', icon: PlayCircle, color: '#4E6178' },
]
    ...
    <section className="bg-ink py-16 md:py-24 space-y-24 border-b border-mist relative overflow-hidden">
      ...
      <div className="max-w-[1200px] mx-auto px-6 space-y-20 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          {/* Mock visual panel */}
          <Reveal delay={150} className="lg:order-1">
            <div className="bg-mist p-6 rounded-2xl border border-mist space-y-3 glow-border" style={glowStyle(2)}>
